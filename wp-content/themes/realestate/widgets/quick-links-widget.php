...
<?php
/**
 * Custom Quick Links Widget
 */



class WP_Quick_Links_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'description'                 => __( 'Add a navigation linls to your sidebar.' ),
			'customize_selective_refresh' => true,
			'show_instance_in_rest'       => true,
		);
		parent::__construct( 'quick_links', __( 'Quick Links' ), $widget_ops );
	}
	 ...
	 * @param array $instance Settings for the current Links Menu widget instance.
	 */
	public function widget( $args, $instance ) {
		...
		$default_title = __( 'Quick links', 'realestate' );
        ...
        echo '<div class="footer-title-line"></div>';
