<?php
/**
 * Custom Tags Cloud Widget
 */


class Realestate_Tags_Cloud extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'realestate_tag_cloud', __( 'RealEstate Tag Cloud' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
			...
			apply_filters(
				'widget_tag_cloud_args',
				 array(
				    ...
				    'largest' => 22,
				    'unit' => 'px',
					'format' => 'array', // формат вывода - массив тегов
                    //'link' => '<a href="%1$s"><i class="fa fa-tags"></i> %2$s</a>',
					'echo'       => false,
		...
		if ($tag_cloud ) {
		    ...
		    foreach ($tag_cloud as $tag ) {
		        ...
		        echo '<li><a href="' . esc_url( $tag_link ) . '"><i class="fa fa-tags"></i> ' . esc_html( $tag->name ) . '</a></li>';
		    }
		    echo '</ul>';
		}
